 ...
 * after". So the centrepiece is THE FOUR ROUTES IN, each with what it is best for, what it
  ...
  return (
    <Shell>
      ...
      <PageHero
        ...
        lede="Calls go to the two people who own the company, not to a call centre and not to a lead service that resells your details. If we are on a roof, we ring you back."
        trail={trail}
        footnote={
          <>
      ...
      {/* ── THE FOUR ROUTES IN ──
        * The centrepiece. Every route says what it is bad for, which is the
