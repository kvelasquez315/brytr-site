  ...
  return (
    <Shell>
      ...
      <PageHero
        ...
        aside={
          <Link href={`/blog/${feat.slug}`} className="block rounded-lg bg-raise p-7 ring-1 ring-accent/15 shadow-[var(--shadow-dark)]">
            <p className="label text-2xs uppercase tracking-[0.14em] text-accent">Start here · {feat.category}</p>
      ...
      <section className="section bg-background">
        <div className="shell">
          <SectionHead eyebrow="All guides" title="Everything, by category." />
