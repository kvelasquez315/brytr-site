 ...
 *
 * What it is now. The organising device is WHAT THE REVIEWS ACTUALLY MENTION, as a rack of
...
const mentions: Record<string, string[]> = {
  ...
  Tricia: ["Neighbours asked who did it", "Would recommend"],
  ...
  return (
    <Shell>
      ...
      <PageHero
        ...
        lede="We would rather send you to the profile than retype our own reviews, so this page does both: the six we quote in full, and what all of them keep coming back to."
        trail={trail}
        footnote={
          <>
      ...
      {/* ── THE RATING, AND WHAT THE REVIEWS MENTION ──
        * The organising device for the page. Counts are of the six quoted below
      ...
      <section className="section bg-background">
        <div className="shell grid items-start gap-10 lg:grid-cols-[34fr_66fr] lg:gap-14">
          ...
          <div>
            <SectionHead
              eyebrow="The organising question"
      ...
      <section className="section bg-muted">
        <div className="shell">
          <SectionHead
            ...
            title="Six of them, in full."
            lede="Copied exactly as written, spelling and exclamation marks included. Five are the testimonials Brytr already publishes; two come straight off the profile."
          />
      ...
      <section className="section bg-primary">
        <div className="shell">
          <SectionHead
            ...
            title="Six practices, not six adjectives."
