 ...
 * right child. So the centrepiece is a DECISION TREE keyed to what a homeowner actually
...
export default function ServicesHub() {
  return (
    <Shell>
      ...
      {/* ── THE DECISION TREE ─────────────────────────────────────────────
        * The centrepiece, and the thing this page has that no other page does. */}
      <section className="section bg-background">
        <div className="shell">
          <SectionHead
            eyebrow="Start here"
            title="Most people arrive saying one of three things."
        ...
        <div className="shell">
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-2">
            {[
              {
                h: "On a house",
                p: "One day for most homes. We work off ladders, mitre at every transition, and walk every scene with you after dark before we leave.",
