...
import {
  AppSplit, VersusTable, CompareGrid, Writing, ServiceArea, CtaBand, ProcessRow, Reviews, Financing, HomeFaq, FinalCta,
  ...
  return (
    <>
      ...
      <main>
        ...
        <CompareGrid />     {/* 13b · nine brand comparisons        · deep    */}
        ...
        <Writing />         {/* 19b · three articles                · neutral */}
