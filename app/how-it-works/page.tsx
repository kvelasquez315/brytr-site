 ...
 *
 * The centrepiece is the same eight inches of fascia board four times, bare to lit, with
...
export const metadata: Metadata = {
  ...
  description:
    "What actually happens on a Brytr install day in Omaha: the fascia measured off the ladder, channel fastened and sealed as we go, mitred corners, then the daylight curb check and every scene walked with you after dark.",
...
const invisible: [string, string][] = [
  ...
  [
    ...
    "Offcuts, screws, packaging, sealant tubes and the aluminium swarf from every cut, off site with us. A driveway with swarf on it ends up in somebody's tyre.",
  ],
];
...
const differences: { h: string; us: string; trade: string }[] = [
  {
    ...
    us: "We come back in the evening, put a powered sample on your actual elevation, and change colour on it while you watch.",
  ...
  },
  {
    ...
    us: "We stand where your neighbours stand, at noon, and look at the eave line. If you can pick the channel out, we have not finished.",
  ...
  },
  {
    ...
    us: "Mitred on the angle at every gable, dormer, bay and valley, then sealed at the joint.",
  ...
  },
  {
    ...
    us: "We pull the rules for your neighbourhood, read them, and file the submission ourselves.",
  ...
  return (
    <Shell>
      ...
      <PageHero
        ...
        photoAlt="Close view of two Omaha gables with the channel following the rake line and mitred at the peak, one gable red and one blue"
        ...
        footnote={
          <>
            Photographed on a finished Brytr install. The mitre at the peak of each gable is cut on the
      ...
      {/* ── THE FASCIA, FOUR TIMES ──
        * The centrepiece. Same board, four states, amber in the last one only. */}
      <section className="section bg-raise">
        <div className="shell">
          <SectionHead
            onDark
            eyebrow="The whole job, in section"
            title="The same board, four times."
      ...
      <section className="section bg-muted">
        <div className="shell">
          <SectionHead
            ...
            title="Six things that are not standard in this trade."
            ...
            <article className="flex flex-col rounded-lg bg-raise p-7 ring-1 ring-on-dark/10">
              ...
              <ul className="mt-6 flex-1 divide-y divide-on-dark/10 border-y border-on-dark/10">
                {[
                  ...
                  ["The covenant submission", "Pulled, read and filed by us, before we schedule anything, if your neighbourhood needs it."],
                ].map(([h, p]) => (
