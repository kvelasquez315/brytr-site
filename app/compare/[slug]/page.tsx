 ...
 *   labour   — `labor`: a company against a Saturday. The comparison is the work.
 */
...
export default async function ComparePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const frame: "compete" | "referee" | "labour" = c.neutral ? "referee" : c.labor ? "labour" : "compete";
  ...
  return (
    <Shell>
        ...
        aside={
          <div className="overflow-hidden rounded-lg bg-card shadow-[var(--shadow-lg)]">
            <div className="flex flex-wrap items-baseline justify-between gap-3 border-b border-border px-6 py-4">
              ...
              <p className="text-xs text-muted-foreground">{frameLabel}</p>
            </div>
            <p className="px-6 py-5 text-[1.05rem] leading-relaxed text-foreground">{c.verdict}</p>
            <dl className="grid grid-cols-2 divide-x divide-border border-t border-border">
              {[
                ...
                <div key={k} className="px-5 py-4">
                  ...
                  <dd className="u mt-1.5 text-[0.95rem] font-semibold text-foreground">{v}</dd>
                </div>
              ))}
            </dl>
          </div>
      ...
      <section className="section bg-background">
        <div className="shell">
          <SectionHead
            ...
            title={frame === "labour" ? "The job, not the datasheet." : `${c.a} against ${c.b}, spec by spec.`}
            lede={
              frame === "labour"
      ...
      {/* ── THE FRAME-SPECIFIC SECTION ──
        ...
        * labour  → what a DIY install actually costs you that is not money. */}
      {frame === "compete" && (
        <section className="section bg-background">
          ...
          <div className="shell">
            ...
            <ul className="mt-10 grid gap-5 sm:grid-cols-2 xl:grid-cols-3">
              {[
                ...
                ["Ask how corners are handled", "Cut and mitred, or flexed around. A kink at a valley is visible from the street and cracks first in February."],
          ...
          <div className="shell grid items-start gap-10 lg:grid-cols-[46fr_54fr] lg:gap-14">
            ...
            <ul className="divide-y divide-border border-y border-border">
              {[
                ...
                ["It shows in daylight", "Consumer channel is not colour matched to your trim, and adhesive mounts sit proud of the board. This is the part people regret."],
                ["Corners", "There is no mitre saw in the box. Every gable and valley is a bend, and bends are where a run cracks."],
      ...
      <section className="section bg-raise">
        <div className="shell grid items-start gap-10 lg:grid-cols-[38fr_62fr] lg:gap-14">
          <div>
            <SectionHead onDark eyebrow="Read next" title="The two most people read after this one." />
            ...
            {alsoSee.map((o) => (
              <li key={o.slug}>
                ...
                >
                  ...
                  <span className="label mt-4 border-t border-on-dark/12 pt-3 text-accent">
                    {o.neutral ? "We have no stake in this one" : o.labor ? "Labour, not brand" : "Read it"}
                  </span>
                </Link>
              </li>
            ))}
