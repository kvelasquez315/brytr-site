 ...
 * is checkable. So the centrepiece is WHAT WE MAKE LESS MONEY ON — the decision, what it
...
/* THE CENTREPIECE. Four structural decisions, each one costing something specific. The
...
const costs: { chip: string; h: string; p: string; cost: string }[] = [
  ...
  },
  {
    ...
    p: "A simple single-story roofline with two elevations and no colour ambition does not need the premium tier, and we say so at the table rather than after you have signed. Sometimes that is a worse day for us and a better system for you.",
  ...
  return (
    <Shell>
              ...
              {[
                {
                  ...
                  s: "Premium",
                  when: "Complex rooflines, multiple elevations, anyone who will actually use colour and scenes. Where the extrusion, the optics and the controller earn the difference.",
                },
                {
      ...
      {/* ── WHAT WE MAKE LESS MONEY ON ──
        * The centrepiece. Every claim on an about page is worthless unless it
      ...
      <section className="section bg-primary">
        <div className="shell">
          <SectionHead
            ...
            title="Six decisions that make us less money."
      ...
      {/* ── ZAC AND SAM ──
        * Landscape monogram panels, not empty portrait slots. Portraits are on
        * the shot list; when they arrive they drop into the same box. */}
