 ...
 * turns up — so it answers them in that order and refuses to pad. The centrepiece is
...
const covered: { h: string; by: "Manufacturer" | "Brytr"; p: string }[] = [
  ...
  },
  {
    ...
    by: "Manufacturer",
    p: "The extrusion and its coating. Colour fade and corrosion on the aluminium itself sit with whoever extruded it.",
  },
  {
  ...
  {
    h: "Mitres, transitions and end caps",
    by: "Brytr",
...
const notCovered: { h: string; p: string }[] = [
  ...
  },
  {
    ...
    p: "If a run has been cut into, extended or re-terminated by somebody else, we cannot stand behind the part of the system we no longer recognise. We can still quote putting it right.",
  },
  {
  ...
  },
  {
    ...
    p: "Wanting a different colour, a different schedule or a different zone is a settings conversation and usually a five minute phone call. Wanting the channel moved is a quote.",
  },
  {
  ...
  return (
    <Shell>
      ...
      {/* ── COVERED, FACING NOT COVERED ──
        * The centrepiece. Everybody in this trade publishes the left column.
      ...
      <section className="section bg-primary">
        <div className="shell">
          <SectionHead
            ...
            title="Five questions worth asking any installer."
