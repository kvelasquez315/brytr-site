 ...
 *
 * What it was: a flat colour band for a hero (no photograph at all), the form beside a
 ...
 *
 * What it is now. The hero is the home page's, on the warm-white shot — because the
 * everyday setting is what somebody is actually buying, and the walk lit in that frame is
 * the argument. The centrepiece is THE HOUR: five beats with the clock running down the
...
const beats: { at: string; h: string; p: string; who: string }[] = [
  ...
  },
  {
    ...
    p: "This is why evenings are better. We put real output on the house from a sample run, change the colour on a phone, and you say yes or no to each thing while you are looking at it rather than at a render.",
  ...
  return (
    <Shell>
      ...
      <PageHero
        ...
        photoAlt="An Omaha two-story on everyday warm white, with the front walk and beds lit as well as the roofline"
        objectPosition="22% 62%"
        eyebrow="No charge, no obligation"
        h1="See it on your house before you buy."
        lede="We come out, walk the property after dark, design it with you, measure the roofline, and leave you holding a written quote. If you decide against it you have lost an hour and gained a plan."
        trail={trail}
        footnote={
          <>
            This is the everyday setting on a finished install — not a holiday scene. It is what the
            house looks like the other eleven months, which is the part most people have not pictured.
          </>
        }
      />
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-2">
            <div className="flex flex-col rounded-lg bg-card p-7 shadow-[var(--shadow-lg)]">
              ...
              <ul className="mt-6 flex-1 divide-y divide-border border-y border-border">
                {[
                  ...
                  ["The app, on a phone", "We change the colour on the sample while you watch, so scenes are a thing you have used before you buy them."],
            ...
            <div className="flex flex-col rounded-lg bg-primary p-7 shadow-[var(--shadow-dark)] ring-1 ring-on-dark/10">
              ...
              <ul className="mt-6 flex-1 space-y-3.5">
                ...
                <Check onDark>Your covenant or HOA rules, if your neighbourhood has them</Check>
              ...
              <p className="mt-7 border-t border-on-dark/12 pt-5 text-sm leading-relaxed text-on-dark-muted">
                If your neighbourhood needs a submission, we pull the paperwork and file it. That is our
                job, not yours.{" "}
      ...
      <section className="section bg-primary">
        <div className="shell">
          <SectionHead
            ...
            title="Three things that will not happen in your driveway."
