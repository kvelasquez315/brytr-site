...
export const homeFaqs: Faq[] = [
  ...
  { q: "What happens when a section stops working?",
    a: "You call us and we come out. We are the ones who installed it and we hold the warranty alongside the manufacturer. We also service systems we did not sell, including Jellyfish, Gemstone, Trimlight and Oelo." },
...
export const pricingFaqs: Faq[] = [
  ...
  { q: "What makes one quote higher than another on the same house?", a: "Story count, roof complexity, how many corners and transitions need mitering, whether you want landscape or bistro on the same visit, and which system tier you choose. Those five things explain almost every difference." },
  ...
  { q: "Is the cheaper tier a worse install?", a: "No. The crews, the fastening method, the sealing and the verification walk are identical on both tiers. What differs is the hardware: LED spacing, whether the white is a dedicated channel or color-mixed, and the rated life. A Basic install done properly outlasts a Signature install done badly." },
...
export const serviceFaqsFor = (name: string): Faq[] => [
  ...
  { q: "Do you service other brands?",
    a: "Yes. We take over and repair systems we did not install, including Jellyfish, Gemstone, Trimlight and Oelo." },
