 ...
 * wins, the cost tiers, and the neutral / labour flags. What it does not hold is the thing
...
export const compareDetail: Record<string, CompareDetail> = {
  ...
  "haven-vs-oelo": {
    ...
    unknowns: [
      ...
      "How their channel behaves on an aluminium fascia over five winters. We have serviced a small number of their installs and it is not enough to generalise from.",
    ],
  ...
  "haven-vs-ghouly": {
    ...
    objectPosition: "50% 45%",
    unknowns: [
      "Which factory made any particular batch. That is the honest centre of this page: nobody selling permanent lighting in this country, us included, can tell you with certainty which line their diodes came off.",
