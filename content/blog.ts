...
export const posts: Post[] = [
  ...
  B({ slug: "permanent-lights-vs-hanging-christmas-lights", title: "Permanent Lights vs Hanging Christmas Lights",
    ...
    dek: "One is a fixture. The other is a chore with a recurring invoice. Here is the comparison laid out properly.",
    links: { label: "Permanent Christmas lights", href: "/services/permanent-christmas-lights" },
    body: [
  ...
  B({ slug: "installing-permanent-lights-in-nebraska-winter", title: "Can Permanent Lights Be Installed in a Nebraska Winter?",
