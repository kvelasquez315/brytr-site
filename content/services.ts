...
export const services: Service[] = [
  ...
  },
  {
    ...
    h1: "Landscape lighting, designed on your own planting.",
    keyword: "landscape lighting omaha",
    volume: "150/mo",
    icon: "pathLight",
    photo: "serviceLandscape",
    lede:
      "Ground-level work: path runs, uplighting on mature trees, bed washes and column lights. Designed on site, against the planting you actually have.",
    includes: [
