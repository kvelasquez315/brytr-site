/* INSTALL DAY, IN FOUR STAGES — the centrepiece of /how-it-works, and nowhere else.
 *
...
const stages: Stage[] = [
  ...
  },
  {
    ...
    p: "Extruded aluminium, colour matched to your trim, fastened into the fascia board on a fixed screw pitch. Nothing is fastened through a shingle, ever, on any elevation.",
    alt: "The same roof edge with the aluminium channel fastened under the fascia board on two screws",
    art: (
      <>
        <Roof />
        <Fascia />
      ...
      {stages.map((s) => (
        ...
        >
          ...
          {/* text-on-dark, because the drawing is built on currentColor: without it the
            * inherited body colour is near-black and the figure renders black-on-night. */}
