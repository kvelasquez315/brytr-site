...
/* SERVICE PAGE CENTREPIECES — one per service, no two alike.
 *
  ...
  return (
    <figure className="overflow-hidden rounded-lg bg-primary shadow-[var(--shadow-dark)] ring-1 ring-on-dark/10">
      ...
      {/* text-on-dark, because every drawing below is built on currentColor: without it the
        * inherited body colour is near-black and the whole figure renders black-on-night.
        * The two ink weights are opacities of THIS colour. */}
      ...
      <div className="grid gap-7 lg:grid-cols-[56fr_44fr] lg:items-center">
        ...
        <ol className="divide-y divide-on-dark/10 border-y border-on-dark/10">
          {[
            ...
            ["Aluminum channel", "Extruded, colour matched, mitred at each transition."],
...
function ScenesFigure() {
  ...
  return (
    <Frame
      ...
      caption="Eight of the scenes on this list are the same two Omaha houses on different nights. Nothing here is a render and nothing was recoloured."
    >
